...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.daitonet.co.jp/medical/"
GAKKAI = "ダイト（医療機関）"

SELECTOR_TITLE = "ul#ajax_medicalinfoAll li"
title_selector = "p.el_news_text"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul#ajax_medicalinfoAll li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "年"
month_unit = "月"

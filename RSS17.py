...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.teijin-pharma.co.jp/pressrelease/index.html?nid=tei_cont"
GAKKAI = "帝人（プレスリリース）"

SELECTOR_TITLE = "table.comp-news tr"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "table.comp-news tr"  # typo修正済み
date_selector = "th"
date_index = 0
year_unit = "年"
month_unit = "月"
...
POPUP_BUTTONS = ["同意"] if POPUP_MODE else [] 

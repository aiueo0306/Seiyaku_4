...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.tsumura.co.jp/news/"
GAKKAI = "ツムラ"

SELECTOR_TITLE = "ul.l-news-list a"
title_selector = "p.l-news-list__text"
title_index = 0
href_selector = ""
href_index = 0
SELECTOR_DATE = "ul.l-news-list span.l-news-list__date"  # typo修正済み
date_selector = ""
date_index = 0
year_unit = "."
month_unit = "."

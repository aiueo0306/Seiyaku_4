...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.tatsumi-kagaku.com/public/info_medical/information.php"
GAKKAI = "辰巳化学（医療機関）"

SELECTOR_TITLE = "ul.clr.info_medical-list-news li.clr"
title_selector = "span.txt"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.clr.info_medical-list-news li.clr"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "."
month_unit = "."

...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://med.daiichisankyo-ep.co.jp/information/"
GAKKAI = "第一三共エスファ(医療機関)"

SELECTOR_TITLE = "div.tab_cnt__item div.news__item__cnt"
title_selector = "p.news__item__ttl"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.tab_cnt__item p.news__item__time"  # typo修正済み
date_selector = ""
date_index = 0
year_unit = "."
month_unit = "."

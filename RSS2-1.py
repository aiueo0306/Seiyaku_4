...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.taiyo-pharma.co.jp/ja/med_home/info.html"
GAKKAI = "太陽ファルマ(製品)"

SELECTOR_TITLE = "ul.tabItems a"
title_selector = "span.news_tx"
title_index = 0
href_selector = ""
href_index = 0
SELECTOR_DATE = "ul.tabItems a"
...
POPUP_BUTTONS = ["OK"]  # 正確なボタン表記だけを指定
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed2-1.xml"

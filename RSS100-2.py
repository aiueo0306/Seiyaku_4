...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.taiho.co.jp/medical/news/"
GAKKAI = "大鵬薬品(医療機関)"

SELECTOR_TITLE = "ul.m-list-news li"
title_selector = "p.news-ttl"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.m-list-news li"
...
POPUP_BUTTONS = ["薬局薬剤師"]  # 正確なボタン表記だけを指定
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed100-2.xml"

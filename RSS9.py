...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.daiichisankyo-ep.co.jp/"
GAKKAI = "第一三共エスファ（お知らせ）"

SELECTOR_TITLE = "ul.newsUl.newsUl0 li"
title_selector = "span.underline"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.newsUl.newsUl0 li"  # typo修正済み
date_selector = "p.news__date"
date_index = 0
year_unit = "."
month_unit = "."
day_unit = ""

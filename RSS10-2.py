...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.medicalcommunity.jp/products/news"
GAKKAI = "第一三共(医療機関)"

SELECTOR_TITLE = "ul.mod__news__list li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.mod__news__list li"
...
POPUP_BUTTONS = ["薬剤師","すべてのCookie を受け入れる"] if POPUP_MODE else [] 
